...
def main():
    ...
    spot_light = SpotLightSource(intensity=[0.8, 0.8, 0.8], position=[3.5, 3.5, 3.5],
                                 direction=[0.5, 0.5, 0.5], theta=90.0)
    infinity_light = InfinityLightSource([0.3, 0.5, 0.4], [1., 0., 1.])
    scenario = Scenario(objects=[cube], light_sources=[punctual_light, infinity_light, spot_light],
